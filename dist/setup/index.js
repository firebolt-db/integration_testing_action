...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DeprecationError = exports.ConnectionError = exports.AccessError = exports.AuthenticationError = exports.ArgumentError = exports.ApiError = exports.INVALID_PARAMETERS = exports.MISSING_ENGINE_ENDPOINT = exports.MISSING_DATABASE = exports.MISSING_CLIENT_SECRET = exports.MISSING_CLIENT_ID = void 0;
...
class NodeHttpClient {
    request(method, url, options) {
        ...
        const agent = new https_1.Agent({ keepAlive: true, keepAliveMsecs: 1000 });
        const abort = () => {
            controller.abort();
            agent.destroy();
        };
...
class EngineService {
    ...
    async create(name, options = {}) {
        ...
        let query = `CREATE ENGINE ${options.fail_if_exists ? "" : "IF NOT EXISTS "} "${name}"`;
